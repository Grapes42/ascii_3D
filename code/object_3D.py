...
class Object3D():
    ...
    def rotate(self, origin, rads, axis) -> None:
        ...
        for point in self.array[0]:
            ...
            a_f, b_f = self.rot_calc(point, axis_0=axes[0], axis_1=axes[1],
                                     a_o=a_o, b_o=b_o, rads=rads)
            
            # Update shape
            point[axes[0]] = a_f
            point[axes[1]] = b_f

        a_f, b_f = self.rot_calc(self.center, axis_0=axes[0], axis_1=axes[1],
                      a_o=a_o, b_o=b_o, rads=rads)
        
        self.center[axes[0]] = a_f
        self.center[axes[1]] = b_f
        
    def rot_calc(self, point, axis_0, axis_1, a_o, b_o, rads):
        # Initial points
        a_i = point[axis_0]
        b_i = point[axis_1]
